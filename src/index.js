...
var duration=36000;//cuanto tiempo dura el movimiento
...
function Circular(){
	...
	tweenBack 	= new  TweenUmd.Tween(current )
		.to({x:-1000},  duration)
		.delay( delay)
		.easing(easing)
		.onUpdate(update);

	tweenHead1 	= new  TweenUmd.Tween(current )
	.to({z: -1000},  duration/2)
	.delay( delay)
	.easing(easing)
	.onUpdate(update);
	tweenHead3 	= new  TweenUmd.Tween(current )
	.to({z: ( 1000)},  duration/2)
	.delay( delay)
	.easing(easing)
	.onUpdate(update);
	...
	tweenHead2 	= new  TweenUmd.Tween(current )
	.to({z:  0},  duration/2)
	.delay( delay)
	.easing(easing)
	.onUpdate(update);

	tweenHead4 	= new  TweenUmd.Tween(current )
	.to({z:  0},  duration/2)
	.delay( delay)
	.easing(easing)
	.onUpdate(update);
	...
	tweenHead1 .chain(tweenHead4 );
	tweenHead4 .chain(tweenHead3 );
	tweenHead3 .chain(tweenHead2 );
...
function setupTween()
{
	...
	update	= function(){
		...
		light.position.x = current.x;
		light.position.y = current.y;
		light.position.z = current.z;
	...
	TweenUmd.removeAll();
		 ...
		 current	= { x:  -1000, y:  500, z: 0 };// ubicacion inicial de las dos esferas
...
function addLights() 
{
	...
	spotLight = new THREE.SpotLight("white", 3);
...
scene.add( mirrorSphereCamera );
	// create the floor 
    var floorTexture = new THREE.TextureLoader().load( '../client/js/images/black.jpg' )
	var plane = new THREE.Mesh(
        new THREE.PlaneBufferGeometry( 6000, 6000 ),
		new THREE.MeshPhongMaterial( {color: 0x111111, specular: 0x101010, map: floorTexture, side: THREE.DoubleSide} )
		);
...
function makeTextSprite( message, parameters,index, esfera )
{
	...
	// border color
	if (esfera){context.strokeStyle = colors_array_2[index]; }else {context.strokeStyle   =colors_array_2[index];}
	...
	context.lineWidth = 4;
	context.fillStyle = colors_array_2[index];
...
// roughnessMap
	...
	var image = document.createElement('img');
	var metalnessMap = new THREE.Texture(image);
	image.onload = function()  {
		metalnessMap.needsUpdate = true;
	};
	image.src ='../client/js/images/Chrome.png';// 'data:image/png;base64,';
...
function createwrittensphere2( sphere_price, sphere_size, orbit, material,sphere_name,indice,index,jndex){
	...
	var geometry =  new THREE.BoxGeometry(50,sphere_size ,50);
...
//adding an texture to the sphere
	...
	//image.src ='../client/js/images/milky-way1.jpg';//'data:image/png;base64,';//'../client/js/images/azul.jpg';// 
	envMap.mapping = THREE.SphericalReflectionMapping;
	material.envMap = envMap;
...
// roughnessMap
	...
	//image.src ='../client/js/images/milky-way1.jpg';// 'data:image/png;base64,';
	roughnessMap.magFilter = THREE.NearestFilter;
	material.roughnessMap = roughnessMap;
...
// index of the main matrix
	...
	for (let indexx=0 ; indexx < sphere_cant_exchange[register_number]-4; indexx++) {
		...
		/*	
			...
			if(sphere_size<10)sphere_size=sphere_size*10;
			if(sphere_size<10)sphere_size=sphere_size*10;*/
				//create the sphere
...
function addSkybox(num,	isnotfirsttime){//Create animated sky
	...
	if (num== 0){
		...
		video[0].src	= "../client/js/images/videoplayback.mp4";
		video[0].autoplay= true;	
		
		 texture = new THREE.VideoTexture( video[0] );
	} */
	var texture;
	texture= new THREE.TextureLoader().load( '../client/js/images/milky-way1.jpg' );
	...
	const materialArray=new THREE.MeshBasicMaterial( {

    

		envMap: materialarray,
