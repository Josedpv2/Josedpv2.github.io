...
var duration=1;//cuanto tiempo dura el movimiento
...
function setupTween()
{
	 ...
	 update	= function(){
				...
				INTERSECTED.scale.set(current.x,current.x,current.x);
	...
	TweenUmd.removeAll();
		 ...
		 current	= { x:  1 };// ubicacion inicial de las dos esferas
		 
		 
		
			grow();//movimiento circular
